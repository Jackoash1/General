...
class Canvas extends JPanel {
    ...
    private void loadTileImages() {
        try {
            ...
            heal = ImageIO.read(new File("assets/heal.png"));
            assert heal.getHeight() == GameGUI.TILE_HEIGHT &&
                    heal.getWidth() == GameGUI.TILE_WIDTH;
        } catch (IOException e) {
                    ...
                    if (currentTiles[i][j] != null) {   //checks a tile exists
                        switch (currentTiles[i][j]) {
                            ...
                            case STAIRS:
                                ...
                                break;
                            case HEAL:
                                g2.drawImage(heal, i * GameGUI.TILE_WIDTH, j * GameGUI.TILE_HEIGHT, null);
                        }
                    }
                }
            }
